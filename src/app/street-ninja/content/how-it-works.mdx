<h2 className="mt-12 dark:text-teal-400">How Street Ninja Works</h2>
...
1. **Text "FOOD Main & Pender"**  
   - 📍 You get a list of nearby food programs, ordered by proximity to your location.  

2. **Need more options?**  
   - Text **"MORE"** to see additional results.  

3. **Want details about a specific place?**  
   - Text **"INFO 3"** to get more details about a specific result. This is especially useful for food programs, which have a lot of details associated with them. 
